...
CustomKeywords.'com.powerbi.components.ChartSelect.showSetting'(GlobalVariable.sec_DataLabelNumber)

WebUI.delay(2)

List<String> initialValue = CustomKeywords.'com.powerbi.components.ChartSelect.getDataLabelNumber'()
...
WebUI.verifyMatch(CustomKeywords.'com.powerbi.components.ChartSelect.checkNoOfDecimal'('VisualObject/tspan_highcharts-data-label', 
...
WebUI.verifyMatch(CustomKeywords.'com.powerbi.components.ChartSelect.checkThousandSeparator'('VisualObject/tspan_highcharts-data-label', 
...
WebUI.verifyMatch(CustomKeywords.'com.powerbi.components.ChartSelect.checkDecimalSeparator'('VisualObject/tspan_highcharts-data-label', 
...
WebUI.verifyMatch(CustomKeywords.'com.powerbi.components.ChartSelect.checkScalingFactor'('VisualObject/tspan_highcharts-data-label'), 
...
WebUI.verifyMatch(CustomKeywords.'com.powerbi.components.ChartSelect.checkPrefix'('VisualObject/tspan_highcharts-data-label'), 
...
WebUI.verifyMatch(CustomKeywords.'com.powerbi.components.ChartSelect.checkSuffix'('VisualObject/tspan_highcharts-data-label'), 
...
List<String> finalValue = CustomKeywords.'com.powerbi.components.ChartSelect.getDataLabelNumber'()

CustomKeywords.'com.powerbi.components.ChartSelect.compareList'(initialValue, finalValue)

CustomKeywords.'com.powerbi.components.ChartSelect.hideSetting'(GlobalVariable.sec_DataLabelNumber)
