...
CustomKeywords.'com.powerbi.components.ChartSelect.EnableSetting'(GlobalVariable.sec_XAxis)
...
CustomKeywords.'com.powerbi.components.ChartSelect.enableToggle'(GlobalVariable.lbl_Title)
